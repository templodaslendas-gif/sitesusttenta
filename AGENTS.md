...
- Hierarquia comercial atual: Susttenta → Embio → Tratamento Embiofert → Embio 3100 → Embio 6000 → Embio 8000 →
  TLC Agro e Ecomax → atendimento de Pedro → contato pelo WhatsApp. Embio 5000+ permanece fora
  da página até que uma futura revisão seja autorizada.
