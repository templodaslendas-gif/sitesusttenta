...
- `hero.tsx`: primeira dobra Susttenta + Embio, com vídeo real do Propulsor sem sobreposição de legenda;
- `embio-overview.tsx`: visão geral exclusiva da linha principal e laboratório apresentado em vídeo de largura total;
- `embiofert-section.tsx`: solução comercial principal, abrindo com operação em vídeo, seguida por explicação e relatos de campo;
- `embio-product-sections.tsx`: seções independentes do Embio 3100 e Embio 6000, com relatos antes da apresentação dos produtos;
