  ...
  return <>
    <footer className="site-footer">
      <div className="container footer-grid">
        <div className="footer-summary"><a className="footer-logo footer-logo-new" href="#inicio"><Image src="/media/brand/susttenta-logo-2026.webp" alt="Susttenta — Gerando Resultados com Sustentabilidade" width={280} height={280} /></a><p>Representante autorizado Embio, com orientação para tratamento biológico de dejetos, ambiência, biodigestores e efluentes.</p><WhatsAppLink message={whatsappMessages.general} ariaLabel="Conversar com a Susttenta pelo WhatsApp; contato vindo pelo site" className="footer-phone footer-whatsapp-contact"><WhatsAppIcon size={25} /><span>+55 (46) 99925-9777</span></WhatsAppLink></div>
