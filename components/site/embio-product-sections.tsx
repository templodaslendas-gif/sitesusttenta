...
export function Embio3100Section() {
  ...
  return <section id="embio-3100" className="section embio-product embio-product-3100"><div className="container">
    <div className="embio-product-layout" data-reveal>
      <div className="embio-product-media"><Image src="/media/embio-official/embio-3100.webp" alt="Embalagem oficial do Embio 3100" width={950} height={950} sizes="(max-width: 900px) 92vw, 42vw" /></div>
      <div className="embio-product-body">
    ...
    <div className="embio-product-report" data-reveal>
      ...
      <ProductVideoGallery items={videos} compact />
    </div>
  </div></section>;
}
...
export function Embio6000Section() {
  ...
  return <section id="embio-6000" className="section embio-product embio-product-6000"><div className="container">
    <div className="embio-product-layout is-reversed" data-reveal>
      <div className="embio-product-media"><Image src="/media/embio-official/embio-6000.webp" alt="Embalagem oficial do Embio 6000" width={950} height={1900} sizes="(max-width: 900px) 92vw, 38vw" /></div>
      <div className="embio-product-body">
