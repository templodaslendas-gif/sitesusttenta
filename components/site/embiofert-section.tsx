...
import { ProductVideoGallery, VideoPlayBadge } from "./product-video-gallery";
...
export function EmbiofertSection({ onOpen }: { onOpen: (item: ProductVideo) => void }) {
  ...
  return <section id="embiofert" className="embiofert-primary"><div className="container">
    ...
    <button type="button" className="embiofert-cinema video-frame" onClick={() => onOpen(videos[0])} data-reveal aria-label="Assistir ao vídeo: Tratamento Embiofert em operação">
      ...
      <VideoPlayBadge label="Assistir ao tratamento em operação" />
    </button>
