...
export function EmbiofertSection() {
  ...
  return <section id="embiofert" className="embiofert-primary"><div className="container">
    ...
    <ProductVideoGallery items={videos.slice(1)} variant="duo" />
  </div></section>;
}
