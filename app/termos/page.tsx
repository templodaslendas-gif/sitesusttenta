...
export default function TermsPage() {
  return <LegalPage eyebrow="Condições de navegação" title="Termos de Uso" intro="Ao acessar este site, você concorda com as condições abaixo e com as políticas de privacidade e cookies.">
    ...
    <h2>4. Propriedade intelectual</h2><p>Marcas, textos, identidade visual, imagens e demais conteúdos pertencem aos respectivos titulares ou são utilizados conforme autorização. A reprodução fora das hipóteses legais depende de autorização prévia.</p>
